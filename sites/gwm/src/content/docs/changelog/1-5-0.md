---
title: v1.5.0
description: 'gwm 1.5.0, released 2026-07-26. gwm is no longer a GitHub-only tool. Issue and pull/merge request lookups now go through a Forge trait with two implementations : the existing GitHub one (gh) and a new GitLab one (glab).'
sidebar:
  order: 7
  label: v1.5.0
---
