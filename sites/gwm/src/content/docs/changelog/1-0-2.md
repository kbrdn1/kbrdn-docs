---
title: v1.0.2
description: 'gwm 1.0.2, released 2026-07-06. A small patch on the 1.0 line: the first documentation screenshot / recording set lands, plus a routine dependency bump. No new features, no behaviour changes, and the machine contracts frozen in 1.0.0 are untouched.'
sidebar:
  order: 14
  label: v1.0.2
---
